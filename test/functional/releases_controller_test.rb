...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { branch: @release.branch, description: @release.description, requester: @release.requester, url: @release.url }
    end
  ...
  test "should update release" do
    put :update, id: @release, release: { branch: @release.branch, description: @release.description, requester: @release.requester, url: @release.url }
    assert_redirected_to release_path(assigns(:release))
  end
